...
- 🔒 **Milestones 1 (hero) & 2 (journey selector) LOCKED** — untouched.
...
- ➡️ **Next (on approval):** continue the **homepage** — remaining sections per docs/07 order §5+ (flagship previews / social proof / final CTA / footer), one reviewable milestone at a time. Then, once the homepage is fully approved, pages in order: Conferences → Weddings → Accommodation → Dining → Spa → Events → Gallery → About → Contact.
